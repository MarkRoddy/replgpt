...
- Enter natural language prompts to interact with an AI coding agent.
- Locally execute code generated by the AI assistant.
- Enter and execute Python code yourself
- Automatically share your Python code, its output and any errors with your coding agent, improving its responses.

 You also have a few useful commands at your disposal:
- /file_to_context <file_path> - Load a file’s content into the context window
- /auto_eval <strategy> - How to decide if code in LLM response should be evaluated. Must be one of always, never, or infer. The default is 'always'.
Type your commands or prompts below."""
# - /help - show a (supposedly) useful help message.
